...
public class ProductIntegrationTest {
    ...
    public void retrieveAll_requestAllProducts_expectAllProductsAsDTOS() throws Exception {
        ...
        List<Product> dummyProducts = productRepository.saveAllAndFlush(Stream.of(new Product(UUID.randomUUID(), "BBC"), new Product(UUID.randomUUID(), "Black")).collect(Collectors.toList()));
